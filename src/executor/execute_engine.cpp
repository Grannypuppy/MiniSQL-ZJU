...
/**
 * @file execute_engine.cpp
 * @brief External C linkage declarations for parser integration
 * 
 * This section provides C linkage declarations necessary for integrating
 * the parser components with the C++ execution engine.
 * 
 * @details The extern "C" block ensures proper linkage between C++ code
 * and C-based parser components including:
 * - yyparse: The main parser function generated by yacc/bison
 * - minisql_lex.h: Lexical analyzer definitions
 * - parser.h: Parser function declarations and data structures
 */
extern "C" {
int yyparse(void);
//FILE *yyin;
...
// SQL语句 → 语法分析(Parser) → 查询计划(Planner) → 执行器(Executor) → 结果输出
ExecuteEngine::ExecuteEngine() {
  // Initialize the execute engine
  // Load all databases from the "databases" directory
  // If the directory does not exist, create it
  // and initialize the DBStorageEngine for each database found
  char path[] = "./databases";
  DIR *dir;
